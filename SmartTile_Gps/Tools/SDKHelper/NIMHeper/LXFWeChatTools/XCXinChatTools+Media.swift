//
//  XCXINChatTools+Media.swift
//  
//
//  Created by FangLin on 2019/1/12.
...
protocol XCXinChatToolsMediaDelegate: NSObjectProtocol {
    /* ============================== 播放音频的回调 ============================== */
    // 准备开始播放音频
...
enum XCXinchatMediaOutputDeviceType {
    case receiver   // 听筒
    case speaker    // 扬声器
}
...
extension XCXinChatTools {
    // MARK: 切换音频的输出设备
    func switchAudioOutputDevice(type: XCXinchatMediaOutputDeviceType = .speaker) {
...
extension XCXinChatTools: NIMMediaManagerDelegate {
    /* ============================== 播放音频的回调 ============================== */
    // MARK: 准备开始播放音频 回调
