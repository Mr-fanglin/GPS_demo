...
// iPhone X底部多余的高度
let IPHONEX_BH:CGFloat = (ISIPHONEX || ISIPHONEXR || ISIPHONE12) ? 34.0:0.0
...
let ISIPHONE12 = (SCREEN_WIDTH == 390.0 && SCREEN_HEIGHT == 844.0)   //iPhone12
...
///相关主题色
let Main_Color:UIColor = HEXCOLOR(h: 0xF37374, alpha: 1.0)
