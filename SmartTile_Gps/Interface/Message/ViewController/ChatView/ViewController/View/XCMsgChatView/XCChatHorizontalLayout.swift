...
class XCChatHorizontalLayout: UICollectionViewFlowLayout {
    // 保存所有item
    ...
    override func prepare() {
        ...
        let itemWH: CGFloat = SCREEN_WIDTH / CGFloat(col)
        ...
        for itemIndex in 0..<itemsCount {
            ...
            // 通过一系列计算, 得到x, y值
            let x = itemSize.width * CGFloat(itemIndex % Int(col)) + (CGFloat(page) * SCREEN_WIDTH)
